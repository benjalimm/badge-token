...
contract PermissionToken is ERC165, IERC721, IERC721Metadata, IPermissionToken {
    ...
    constructor(string memory _entityName, address _entityAddress) {
        _name = string(abi.encodePacked(_entityName, " - Permission token"));
        _symbol = string(abi.encodePacked(_entityName, "_PERM_TOKEN"));
